...
#[derive(Debug)]
pub struct DVCVersionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DVCVersionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DVCVersion processing");
    
    let mut processor = DVCVersionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DVCVersionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DVCVersionProcessor::new(false);
